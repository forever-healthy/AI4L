---
review_canonical_topic: Low-Level Light Therapy for Health & Longevity
review_filename: low_level_light_therapy_2026-0420-2107_Opus_ER.md
prompt_version: 1.0.0
audit_date: 2026-0420-2148
audit_ai: Opus / Opus 4.7
audit_filename: low_level_light_therapy_2026-0420-2107_Opus_QA.md
audit_duration: "00:36"
audit_iterations: 4
---

# Audit: Low-Level Light Therapy for Health & Longevity

Audit conducted on 20/04/2026 21:48 using [AI4L](https://github.com/forever-healthy/AI4L) / Opus 4.7
...
| 1.3 | The document does not jump to conclusions or recommendations prematurely; it builds its case through evidence | 🟢 | |
...
| 1.14 | The document is NOT written for the general population, that is unwilling to employ lifestyle and behavioral changes or follow protocols that may be inconvenient, costly, or require effort. | 🟢 | |
...
| 2.7 | The document does not adopt any professional establishment's consensus position as default truth. Mainstream and dissenting positions are both presented as claims supported (or not) by evidence. | 🟢 | |
...
| 3.11 | Trinomial/subspecies names: genus capitalized; species and subspecies epithets lowercase. Example: "Bifidobacterium animalis subsp. lactis". | N/A | No trinomial/subspecies names in document. |
| 3.12 | Stereochemistry prefixes: `L-`, `D-`, `l-`, `d-`, `cis-`, `trans-`, `R-`, `S-` keep their conventional case and stay hyphenated to the next token. The token following a capitalized prefix is title-cased per CMS ("L-Theanine", "D-Ribose", "cis-9, trans-11 CLA"). | N/A | No stereochemistry prefixes used in document. |
...
| 3.14 | Chemical compound names and IUPAC forms: keep hyphens, numeric locants, and lowercase elements as written ("N-acetylcysteine" in body text, "N-Acetylcysteine" only if it is the canonical_name/short_topic where CMS title-case applies to the word after the prefix). | N/A | No chemical compound/IUPAC names requiring this rule. |
...
| 5.3 | There are no broken links | 🟢 | |
| 5.4 | Link annotations accurately describe the content they are attached to | 🟢 | |
...
| 5.6 | No URLs appear to have been constructed by guessing or interpolating from memory | 🟢 | |
| 5.7 | All pipe characters "|" in markdown link text are replaced with an en-dash "–" | 🟢 | |
...
| 6.4 | If the [initial_topic] of the evidence review is of the form "[intervention(s)] : [goal]", the [topic] is stated as "topic: "[intervention(s)] to/for/as [goal]" using a fitting preposition (e.g., "Metformin : Skin Rejuvenation" → "Metformin for Skin Rejuvenation") | N/A | initial_topic is a single intervention name, not the "[intervention(s)] : [goal]" form. |
| 6.5 | Otherwise [topic] is stated as "topic: [initial_topic]" | N/A | initial_topic matches condition in 6.3. |
...
| 6.10 | The [canonical_name] is simplified and compressed in a way that "and" is replaced by "&", prepositions and wordiness are removed where possible, but the essence is not altered (e.g., "Ivermectin and Mebendazole and Fenbendazole" → " Ivermectin, Mebendazole & Fenbendazole") | 🟢 | |
| 6.11 | [canonical_name] is capitalized following the "Chicago Manual of Style" rules, subject to the scientific-nomenclature overrides in section 3 | 🟢 | |
| 6.12 | The [intervention] is inspected and, if multiple variations, names, alternates, synonyms, or spellings exist, all of them, except [canonical_name], are stated as a comma-separated list as "alternate_names: [alternate_names]" (e.g., "Low Dose Naltrexone, LDN, Naltrexone") | 🟢 | |
| 6.13 | The [canonical_topic] is stated as "canonical_topic: 'Replacing [intervention] by [canonical_name] in [topic]' (e.g., "LDN to Optimize Immune Function" → "canonical_topic: Low-Dose Naltrexone to Optimize Immune Function") | 🟢 | |
| 6.14 | The [canonical_topic] is simplified in a way that prepositions and wordiness are removed where possible, but the essence is not altered (e.g., "Using a combination of Ivermectin, Mebendazole & Fenbendazole to Fight Cancer" → "Ivermectin, Mebendazole & Fenbendazole to Fight Cancer") | 🟢 | |
| 6.15 | [canonical_topic] is capitalized following the "Chicago Manual of Style" rules, subject to the scientific-nomenclature overrides in section 3 | 🟢 | |
| 6.16 | If [goal] is "Health & Longevity" [short_goal] is stated as "Longevity". | 🟢 | |
| 6.17 | If [goal] is not "Health & Longevity", a one keyword form of [goal] containing no verb, is stated as "short_goal: [short_goal]" (e.g., "Optimize Immune Function" → "Immune", "Improve Insulin Sensitivity" → "Insulin", "Support Cardiovascular Health" → "Cardiovascular", "Reduce Inflammation" → "Inflammation", "Skin Rejuvenation" → "Skin") | N/A | Goal is "Health & Longevity", so 6.16 applies. |
| 6.18 | If [short_goal] is "Longevity" [short_topic] is stated as "short_topic: [canonical_name]" | 🟢 | |
| 6.19 | If [short_goal] is not "Longevity" [short_topic] is stated as "short_topic: [canonical_name] ([short_goal])" (e.g., "Low-Dose Naltrexone (Immune)", "Metformin (Cancer)") | N/A | short_goal is "Longevity". |
| 6.20 | [short_topic] is capitalized following the "Chicago Manual of Style" rules, subject to the scientific-nomenclature overrides in rule section 3 | 🟢 | |
| 6.21 | [short_topic_lc]  is stated as "short_topic_lc: ``{[short_topic] converted to lowercase, then spaces and dashes are replaced with underscores, then any remaining non-alphanumeric, non-underscore characters are removed, then any consecutive underscores are collapsed to a single underscore, then any leading or trailing underscores are stripped}`` " (e.g., "Low-Dose Naltrexone (Immune)" → "low_dose_naltrexone_immune", "L-Theanine" → "l_theanine", "EPA & DHA" → "epa_dha", "Vitamin K2 (MK-4 & MK-7)" → "vitamin_k2_mk_4_mk_7")) | 🟢 | |
| 6.22 | Version of the AI4L.md file used to create the document is stated as "prompt_version: [Version of AI4L.md]" | 🟢 | |
| 6.23 | Creation date and time of the document is stated as "creation_date: [YYYY-MMDD-HHMM]" (e.g., 2026-0501-1430) | 🟢 | |
| 6.24 | The nickname of the AI used to create the document is stated as "creator_ai_nickname: [creator_ai_nickname]" | 🟢 | |
| 6.25 | The nickname of the AI is just a single word model name without version, etc. (e.g., Opus, Sonnet, Grok, Gemini, ChatGPT) | 🟢 | |
| 6.26 | The full name of the AI used to create the document is stated as "creator_ai_fullname: [creator_ai_fullname]" | 🟢 | |
| 6.27 | The full name of the AI consists of the [creator_ai_nickname] and the model version number and no additional qualifier (e.g., Opus 4.6, Sonnet 3.2, Grok 4.5, Gemini 3.1, ChatGPT 5.4) | 🟢 | |
| 6.28 | The knowledge cutoff of the AI is stated as "knowledge_cutoff: [knowledge_cutoff]" | 🟢 | |
| 6.29 | The filename of the document is stated as "filename: [short_topic_lc]_[creation_date]_[creator_ai_nickname]_ER.md" (e.g., "Low-Dose Naltrexone (Immune)" → "low_dose_naltrexone_immune_2026-MMDD-HHMM_creator_ai_nickname_ER.md") | 🟢 | |
| 6.30 | All frontmatter values are trimmed: no leading or trailing whitespace, no surrounding quotes unless the value contains a colon, bracket, or leading special character that requires YAML quoting. | 🟢 | |
...
| 9.5 | Content from the following experts is prioritized (where directly relevant content exists): Rhonda Patrick (foundmyfitness.com), Peter Attia (peterattiamd.com), Andrew Huberman (hubermanlab.com), Chris Kresser (chriskresser.com), Life Extension Magazine (lifeextension.com) | 🟢 | |
...
| 9.17 | ONLY if no author is available, the publication is used in the form of " - <publication>" | N/A | All items have author attributions. |
| 9.18 | If the item is a scientific paper, the publication year of the paper is included in the form of " - <author>, <year>" for single-author works or "<last name> et al., <year>" for multi-author works | 🟢 | |
| 9.19 | Each link points to the quoted item (not to a different item or non-existent document) | 🟢 | |
| 9.20 | Each item has a 1–2 sentence annotation in a new paragraph explaining its specific value | 🟢 | |
| 9.21 | The new paragraph for the annotation is separated from the title by a blank line | 🟢 | |
| 9.22 | If content from one or more of the priority experts could not be found, a brief note, visible to the user, at the end of the section explains why | 🟢 | |
| 9.23 | If fewer than 5 high-quality sources could be found, a brief note, visible to the user, explains this, and the list is not padded with marginally relevant content | N/A | Exactly 5 items listed. |
...
| # | Description | Result | Comments |
|---|-------------|:------:|----------|
| 10.1 | A web search was performed on grokipedia.com for the intervention | 🟢 | |
| 10.2 | A statement by the author about the search is placed inside an HTML comment | 🟢 | |
| 10.3 | An independent online search by the auditor has confirmed the presence/absence of the intervention on grokipedia.com | 🟢 | |
| 10.4 | If an article exists, a link to the Grokipedia article is provided | 🟢 | |
| 10.5 | If an article exists, the link points to the site's primary, dedicated page for the intervention — not a filtered search view, research feed, subpage, or FAQ entry | 🟢 | |
| 10.6 | Suffixes in the link title such as " — <sitename>" are removed from the link title | 🟢 | |
| 10.7 | If an article exists, a 1–2 sentence annotation explains its specific value (in a new paragraph) | 🟢 | |
| 10.8 | If no article exists, this is explicitly stated | N/A | An article exists. |
...
| # | Description | Result | Comments |
|---|-------------|:------:|----------|
| 11.1 | A web search was performed on examine.com for the intervention | 🟢 | |
| 11.2 | A statement by the author about the search is placed inside an HTML comment | 🟢 | |
| 11.3 | An independent online search by the auditor has confirmed the presence/absence of the intervention on examine.com | 🟢 | |
| 11.4 | If an article exists, a link to the Examine article is provided | 🟢 | |
| 11.5 | If an article exists, the link points to the site's primary, dedicated page for the intervention — not a filtered search view, research feed, subpage, or FAQ entry | 🟢 | |
| 11.6 | The link title is the title of the Examine article | 🟢 | |
| 11.7 | Suffixes in the link title such as " — <sitename>" are removed from the link title | 🟢 | |
| 11.8 | If an article exists, a 1–2 sentence annotation explains its specific value (in a new paragraph) | 🟢 | |
| 11.9 | If no article exists, this is explicitly stated | N/A | An article exists. |
| 11.10 | If the intervention is a prescription drug and no article was found, this is noted with an explanation (e.g., "Examine.com does not typically cover prescription medications") | N/A | Intervention is not a prescription drug and article exists. |
...
| # | Description | Result | Comments |
|---|-------------|:------:|----------|
| 12.1 | A web search was performed on consumerlab.com for the intervention | 🟢 | |
| 12.2 | A statement by the author about the search is placed inside an HTML comment | 🟢 | |
| 12.3 | An independent online search by the auditor has confirmed the presence/absence of the intervention on consumerlab.com | 🟢 | |
| 12.4 | If an article exists, a link to the ConsumerLab article is provided | 🟢 | |
| 12.5 | If an article exists, the link points to the site's primary, dedicated page for the intervention — not a filtered search view, research feed, subpage, or FAQ entry | 🟢 | |
| 12.6 | The link title is the title of the ConsumerLab article | 🟢 | |
| 12.7 | Suffixes in the link title, such as " — <sitename>", are removed from the link title | 🟢 | |
| 12.8 | If an article exists, a 1–2 sentence annotation explains its specific value (in a new paragraph) | 🟢 | |
| 12.9 | If no article exists, this is explicitly stated | N/A | An article exists. |
| 12.10 | If the intervention is a prescription drug and no article was found, this is noted with an explanation (e.g., "ConsumerLab does not typically cover prescription medications") | N/A | Intervention is not a prescription drug and article exists. |
...
| 13.4 | If NO results exist, the one-sentence description of the section's contents is omitted | N/A | Results exist. |
...
| 13.10 | The link points to the actual paper cited (not to a different publication) | 🟢 | |
| 13.11 | No links point to publisher websites (e.g., ahajournals.org, sciencedirect.com, wiley.com) | 🟢 | |
| 13.12 | The title is shown in plain text, not bold text | 🟢 | |
| 13.13 | The title is followed by a reference to the author and the publication year of the paper in the form of " - <author>, <year>" for single-author works or "<last name> et al., <year>" for multi-author works | 🟢 | |
| 13.14 | Each result has a 1–2 sentence annotation explaining its specific value (in a new paragraph) | 🟢 | |
| 13.15 | The new paragraph for the annotation is separated from the title by a blank line | 🟢 | |
| 13.16 | If no results exist, a statement follows the exact format: "No systematic reviews or meta-analyses for <intervention> were found on PubMed as of <current date>." | N/A | Results exist. |
...
| 14.5 | If the intervention is a pharmacological compound, state its key pharmacological properties: half-life, selectivity, tissue distribution, and metabolism (primary pathway and relevant enzymes, e.g., CYP3A4) | N/A | LLLT is not a pharmacological compound; stated explicitly in ER. |
...
| 15.6 | If the section does not apply to the intervention, this is briefly noted | N/A | Section applies. |
...
| 17.6 | Each factor is presented as a bulleted item with a short bold label followed by descriptive explanation | 🟢 | |
| 17.7 | If none of the above is relevant to the intervention, it is briefly stated | N/A | Factors are relevant and discussed. |
...
| 19.6 | Each factor is presented as a bulleted item with a short bold label followed by descriptive explanation | 🟢 | |
| 19.7 | If none of the above is relevant to the intervention, it is briefly stated | N/A | Factors are relevant and discussed. |
...
| 24.4 | If the section is not applicable to the intervention, this is briefly noted | N/A | Section applies. |
...
| 26.5 | Each interaction is presented as a bulleted item with a bold label (Sleep, Nutrition, Exercise, Stress management) followed by descriptive explanation | 🟢 | |
...
| 27.12 | If the section is not applicable to the intervention, this is briefly noted | N/A | Section applies. |
...
| 28.7 | Any other referenced source with a known URL is linked | 🟢 | |
| 28.8 | Ongoing trials are presented with a descriptive title or aim, the NCT ID as a hyperlink (or a note if no NCT ID exists), and key details such as participant count, phase, or primary endpoint where available | 🟢 | |
| 28.9 | Future research areas reference specific studies or meta-analyses by author/year with a hyperlink where relevant published evidence exists | 🟢 | |
| 28.10 | Emerging Research entries are presented as bulleted items beginning with a short bold label | 🟢 | |
...
| 30.14 | The final paragraph does not use evaluative or advisory language — it states what the review examines, not what anyone should do | 🟢 | |
...
<section id="history" markdown="1"></section>

## Issues 20/04/2026 21:48

Pass rate 100.00%. No issues found.


## Issues 20/04/2026 21:37

1. **2.8 — Device-maker conflict of interest not named:** The ER does not identify/name device-maker financial interests at first citation of industry-funded evidence (e.g., Joovv, Mito Red Light, Platinum LED, THOR, Vielight at lines 384 and 434–437) and the Conclusion (line 449) only vaguely references "a mix of industry, clinical, and independent funding" without naming the parties.
2. **19.2 — Baseline biomarkers missing from risk factors:** The Risk-Modifying Factors section (lines 294–300) does not include a bullet point for baseline biomarker levels as a risk-modifying factor; baseline biomarkers appear only in Benefit-Modifying Factors and the Therapeutic Protocol.


## Fixes 20/04/2026 21:37

1. **2.8 — Named device-maker COI:** Added an explicit conflict-of-interest note at first citation in the Systematic Reviews section naming consumer panel makers (Joovv, Mito Red Light, Platinum LED), clinical/research device makers (THOR, BioFlex, Medx, Vielight), and WALT; also named these parties in the Conclusion, replacing the vague "mix of industry, clinical, and independent funding" phrasing. Tightened the Conclusion to stay within the 150–250 word limit after the addition.
2. **19.2 — Added baseline biomarker risk factor:** Added a new "**Baseline biomarkers:**" bullet to the Risk-Modifying Factors section covering porphyrin precursors, ANA positivity for photosensitive autoimmune disease, mitochondrial disorder markers, and prior drug/UV photosensitivity as flags for specialist review.

## Issues 20/04/2026 21:24

1. **3.10 — Binomial not italicized:** "Hypericum perforatum" at line 306 is written in plain text; binomial species names should be italicized in body text per rule 3.10.
2. **9.16 / 9.17 — Publication used when author available:** The Life Extension item at line 67 cites "- Life Extension" (publication) as the reference; the actual article has an identified author (Brooke Diaz). Per 9.17 the publication is used only when no author is available, so the author name should be used instead.
3. **30.19 — Motivation cites specific trial details:** Line 37 references "An umbrella review published in 2025 synthesizing over 200 randomized trials" — citing a specific publication year and sample size, which rule 30.19 forbids in the Motivation section.


## Fixes 20/04/2026 21:24

1. **3.10 — Binomial italicized:** Changed "Hypericum perforatum" to *Hypericum perforatum* at line 306 so the binomial species name is italicized in body text per the scientific-nomenclature rule.
2. **9.16 / 9.17 — Author replaces publication:** Replaced "- Life Extension" with "- Brooke Diaz" for the Life Extension article at line 67, using the article's actual author rather than the publication name.
3. **30.19 — Motivation trial citation removed:** Rewrote the closing sentence of the second motivation paragraph to remove the specific year ("2025") and sample size ("over 200 randomized trials"), now reading as a generic reference to "Recent evidence syntheses"; the motivation word count remains within the 150–200 range.



## Issues 20/04/2026 21:13

1. **13.13 — Leal-Junior citation year:** The Leal-Junior et al. paper at line 121 is cited as "2013"; its journal publication year on PubMed (PMID 24249354, Lasers Med Sci 30(2):925-39, Feb 2015) is 2015, with 2013 being only the Epub-ahead-of-print date.
2. **28.2 — Trials described as ongoing are completed:** NCT05563298 (Neuro RX Gamma aMCI, line 434) and NCT02404402 (LED-TBI, line 436) are both marked COMPLETED on clinicaltrials.gov (Feb 2025 and Jun 2025 respectively), but the ER presents them with present-tense "is evaluating"/"is examining" phrasing implying ongoing status.
3. **28.8 — Missing trial details:** None of the four NCT-ID trials in the Emerging Research section report participant count, phase, or primary endpoint. Available values include NCT03551392 (n=24, NA phase), NCT05563298 (n=20, Early Phase 1), NCT05675930 (n=44, Phase 2, 28-day response rate), and NCT02404402 (n=8, NA phase).


## Fixes 20/04/2026 21:13

1. **13.13 — Leal-Junior citation year:** Updated "Leal-Junior et al., 2013" to "Leal-Junior et al., 2015" to reflect the paper's journal publication year (Lasers Med Sci 30(2):925-39, Feb 2015) rather than the Epub-ahead-of-print date.
2. **28.2 — Completed trials reframed:** Rewrote NCT05563298 and NCT02404402 entries to reflect their COMPLETED status on clinicaltrials.gov (data collection concluded Feb 2025 and Jun 2025 respectively) instead of present-tense "is evaluating"/"is examining" phrasing.
3. **28.8 — Added trial details:** Added participant count, phase, design, and primary-endpoint information for all four NCT-linked trials (NCT03551392 n=24 Phase NA; NCT05563298 n=20 Early Phase 1; NCT05675930 n=44 Phase 2; NCT02404402 n=8 Phase NA).
